...
def parse_arguments():
    ...
    parser.add_argument('--vocab', '-v', type=str, default='dataset/vocab.pkl', help='vocabulary (.pkl)')
    # parser.add_argument('--dataset', '-d', type=str, default='dataset/chembl_25.csv', help='train corpus (.csv)')
    parser.add_argument('--dataset', '-d', type=str, default='dataset/chembl_24.csv', help='train corpus (.csv)')
...
def main():
    ...
    model = TrfmSeq2seq(len(vocab), args.hidden, len(vocab), args.n_layer)
