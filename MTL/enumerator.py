...
class Iterator(object):
    """Abstract base class for dataset iterators.

    # Arguments
        n: Integer, total number of samples in the dataset to loop over.
        batch_size: Integer, size of a batch.
        shuffle: Boolean, whether to shuffle the dataset between epochs.
        seed: Random seeding for dataset shuffling.
    """
    ...
    def __init__(self, n, batch_size, shuffle, seed):
        ...
        if n < batch_size:
            raise ValueError('Input dataset length is shorter than batch_size\nAdjust batch_size')
...
class SmilesIterator(Iterator):
    """Iterator yielding dataset from a SMILES array.

    # Arguments
        x: Numpy array of SMILES input dataset.
        y: Numpy array of targets dataset.
